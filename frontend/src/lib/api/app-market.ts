...
export function getMarketApps() {
  return api.get<MarketAppState[]>('/app-market/apps');
}

export function getCrmAppState() {
  return api.get<MarketAppState>('/app-market/apps/crm/status');
}

export function purchaseCrmApp() {
  return api.post<MarketAppState>('/app-market/apps/crm/purchase', {});
}

export function installCrmApp() {
  return api.post<MarketAppState>('/app-market/apps/crm/install', {});
}

export function uninstallCrmApp() {
  return api.post<MarketAppState>('/app-market/apps/crm/uninstall', {});
}
