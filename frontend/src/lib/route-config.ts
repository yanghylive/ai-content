...
export const routeBreadcrumbs: Record<string, BreadcrumbRoute> = {
  ...
  "/admin/executor": { sectionTitle: "设置", title: "电脑本机服务", selectedKey: "/local-engine" },
  ...
  "/local-engine": { sectionTitle: "设置", title: "电脑本机服务", selectedKey: "/local-engine" },
  "/admin/local-engine": { sectionTitle: "设置", title: "电脑本机服务", selectedKey: "/local-engine" },
