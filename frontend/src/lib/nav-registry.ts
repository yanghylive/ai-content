...
export const INTERACTION_CHANNELS: InteractionChannelEntry[] = [
  ...
  { key: "channel-messages", title: "视频号私信", desc: "私信和评论", sub: "私信和评论", href: "/engagement/channel-messages", icon: "chatRound", tint: "kx-t-cyan", brand: "#007fff" },
  { key: "wechat", title: "微信", desc: "会话、加好友", sub: "会话 · 加好友", href: "/engagement/wechat", icon: "wechatBubble", tint: "kx-t-green", brand: "#07c160" },
  { key: "wecom-assistant", title: "企微助手", desc: "企业微信客户智能回复助手", sub: "企微智能回复", href: "/engagement/wecom-assistant", icon: "botSq", tint: "kx-t-green", brand: "#07c160" },
