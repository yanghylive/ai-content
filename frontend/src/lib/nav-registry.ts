...
export const MINE_NAV_ENTRIES: MineNavEntry[] = [
  ...
  { key: "settings-entry", title: "设置", desc: "账号、通知、AI 服务等全部设置", href: "/settings", icon: "settings", tint: "kx-t-slate", group: "设置", desktopOrder: 1, mobileTint: "var(--kaypal-v3-muted)", mobileTop: true },
  ...
  { key: "settings-integrations", title: "AI 服务与存储", desc: "模型、内容来源、文件存储", href: "/settings/integrations", icon: "rss", tint: "kx-t-violet", group: "设置", desktopOrder: 5, mobileTint: "var(--kaypal-v3-purple)", mobileGroup: "更多能力" },
