...
const COMMANDS: PaletteCommand[] = [
  ...
  { cat: "执行中心", name: "任务证据", icon: "history", tint: "kx-t-slate", href: "/tasks/evidence", kw: "结果 留存 证据 evidence 任务 结果留存" },
  ...
  { cat: "系统设置", name: "电脑本机服务", icon: "cpu", tint: "kx-t-slate", href: "/local-engine", kw: "local engine 本地 引擎 设备 本机 电脑 服务" },
  { cat: "系统设置", name: "商业就绪", icon: "rocket", tint: "kx-t-amber", href: "/commercial-readiness", kw: "商业 就绪 自检 上线 readiness" },
  { cat: "系统设置", name: "数据用量", icon: "file", tint: "kx-t-amber", href: "/intelligence/costs", kw: "积分 用量 费用 账单 用量与费用" },
