...
const COMMANDS: PaletteCommand[] = [
  ...
  { cat: "场景", name: "AI 助手 · 对话", icon: "sparkles", tint: "kx-t-violet", href: "/agent", kw: "agent ai 助手 对话 聊天" },
  { cat: "客户", name: "找客户（新建获客）", icon: "target", tint: "kx-t-rose", href: "/growth-v2/acquisition", kw: "leads 获客 找客户" },
  { cat: "客户", name: "线索池", icon: "target", tint: "kx-t-rose", href: "/growth-v2/leads", kw: "线索 意向" },
  { cat: "客户", name: "客户管理 CRM", icon: "users", tint: "kx-t-blue", href: "/crm", kw: "crm 客户 档案" },
  { cat: "客户", name: "获客任务", icon: "bot", tint: "kx-t-violet", href: "/growth-v2/acquisition", kw: "自动获客 任务" },
  { cat: "客户", name: "获客策略", icon: "clipboard", tint: "kx-t-amber", href: "/growth-v2/strategies", kw: "策略 打法" },
  { cat: "内容", name: "做内容（AI 生成）", icon: "pen", tint: "kx-t-blue", href: "/content/articles", kw: "写作 ai 生成 图文" },
  { cat: "内容", name: "素材库", icon: "archive", tint: "kx-t-violet", href: "/materials", kw: "素材 采集" },
  { cat: "内容", name: "视频工坊", icon: "video", tint: "kx-t-rose", href: "/content/video", kw: "视频 剪辑 换脸" },
  { cat: "内容", name: "发布", icon: "send", tint: "kx-t-green", href: "/distribution-v2/publish-video", kw: "publish 发布 抖音 小红书" },
  { cat: "消息", name: "AI 客服", icon: "bot", tint: "kx-t-violet", href: "/engagement", kw: "客服 回复 确认" },
  { cat: "消息", name: "待我确认", icon: "checkCircle", tint: "kx-t-amber", href: "/tasks/confirmations", kw: "确认 放行 审批" },
  { cat: "消息", name: "抖音评论", icon: "music", tint: "kx-t-slate", href: "/engagement/douyin-comments", kw: "抖音 评论" },
  { cat: "消息", name: "视频号评论", icon: "play", tint: "kx-t-cyan", href: "/engagement/wechat-channel-comments", kw: "视频号 评论" },
