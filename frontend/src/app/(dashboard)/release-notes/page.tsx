...
const highlights = [
  {
    title: "采集→素材→创作/发布 闭环修复",
    text: "修复真机反馈的多处断裂：素材库分页一次看全 300+ 素材、文章反抓正文提取、抖音私信平台识别、微信群发向导接入。",
    icon: <RefreshCw className="h-5 w-5" strokeWidth={1.8} />,
  },
  {
    title: "AI 生图生视频切换百炼引擎",
    text: "生图（qwen-image，可选方图/竖图/横图）、生视频（happyhorse，可选 3-15 秒）稳定出图出片；视频一键成片独立为专属产品页。",
...
const improvements = [
  "素材库：分页加载更多，一次看全全部素材，不再只显示前 20 条。",
  "AI 生图：支持尺寸选择（方图 1:1 / 竖图 3:4 / 横图 4:3），竖图适配小红书封面。",
  "AI 生视频：支持时长选择（3/5/10/15 秒），百炼 happyhorse 引擎稳定出片。",
  "功能子页统一补齐「返回上一级」按钮，浏览路径更顺畅。",
  "页面顶部图标在桌面端不再撑大，全局统一。",
  "版本号、更新说明统一更新到 v1.1.82。",
];

const fixedIssues = [
  "修复素材库「始终 20 篇」（前端默认只拉 20 条，实际素材 300+）。",
  "修复文章反抓正文恒空（正文容器 fallback 逻辑错误）。",
  "修复抖音私信误报「视频号未登录」（平台未传时默认走视频号分支）。",
  "修复微信群发入口误标「路线图」（实际能力已具备，接入真实向导）。",
  "修复 AI 生图生视频失败（原引擎服务端异常，切换百炼引擎兜底）。",
  "修复全网采集翻页不累加、去水印识别不了分享链接、素材库选完无下一步。",
];
