...
const highlights = [
  {
    title: "电脑端与手机同款 AI 助手",
    text: "「助手」页复用手机 App 的云端对话：热点选题、文案创作、违禁词检测、购物比价和返利管理，语音文字都可用。",
    icon: <LayoutGrid className="h-5 w-5" strokeWidth={1.8} />,
  },
  {
    title: "获客任务真实执行恢复",
    text: "「立即执行」不再被占位账号、能力误判挡住：预检通过后创建一次性确认单，真实在抖音找客户、发评论并留证。",
    icon: <ShieldCheck className="h-5 w-5" strokeWidth={1.8} />,
  },
  {
    title: "空壳功能页转正",
    text: "企微助手（群机器人/AI 自动回复/转人工）和评论洞察（粘贴评论一键分析痛点需求）从占位页变成真实可用功能。",
...
const userScenarios = [
  ...
  "电脑端「助手」页与手机 App 使用同一套 AI 对话，会话和积分互通。",
  "从今日、内容、客户、消息进入常用能力，看到的是统一、克制的商业化图标。",
  "没有任务在跑时，浏览器窗口不会再自己弹出打扰工作。",
];

const improvements = [
  "「助手」页复用手机 App 的 AiAssistant 组件（ai-gateway 云端对话），桌面端与移动端体验一致。",
  "获客任务创建强制绑定真实账号，不再降级为 default 占位账号。",
  "抖音获客 5 个能力恢复真实执行状态（此前被误判为只能预演）。",
  "企微助手接入 8 个后端接口：连接/测试/启停/设置/AI 回复建议/消息记录。",
  "评论洞察接入 analyze：痛点、需求、异议、意向关键词、高频问题、回复建议。",
  "补齐 11 个功能入口：情报报告、趋势雷达、AI 客服、朋友圈计划、记忆设置、Agent 对话等。",
  "后台轮询不再触发账号验证，浏览器窗口不会反复弹出（验证冷却 60 秒兜底）。",
  "版本号、页脚、登录页和更新说明统一更新到 v1.1.75。",
];

const fixedIssues = [
  "修复无操作时抖音/小红书 Chrome 窗口反复弹出到前台的问题。",
  "修复获客任务「立即执行」报「未找到可验证的执行账号」的问题（占位账号降级）。",
  "修复抖音获客能力全部误判 simulated、真实执行报「没有可用的执行器」的问题。",
  "修复「立即执行」确认时报「确认编号不能为空」的问题（补齐创建确认单步骤）。",
  "修复企微助手、评论洞察页面是空壳、点开没有真实功能的问题。",
  "修复一批功能页面没有导航入口、只能输网址访问的问题。",
  "清理 11 个被新版替代的旧页面和废弃导航配置，避免误入旧入口。",
];
