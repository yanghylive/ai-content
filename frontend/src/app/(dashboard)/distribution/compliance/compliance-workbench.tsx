        ...
        <div className="grid xl:grid-cols-[minmax(360px,0.74fr)_minmax(0,1.26fr)]">
          <div className="border-b border-[var(--kaypal-v3-border)] p-4 xl:border-b-0 xl:border-r">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2">
              <button
                className="inline-flex h-11 items-center gap-2 rounded-[8px] bg-[image:var(--kaypal-v3-gradient-primary)] px-4 text-13 font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-60"
                disabled={loading}
  ...
  return (
    <div className="flex min-w-0 flex-col gap-3">
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <button
                  className="inline-flex h-11 items-center gap-2 rounded-[8px] bg-[image:var(--kaypal-v3-gradient-primary)] px-3 text-sm font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-60"
      ...
      <div className="flex flex-col gap-2 rounded-[8px] border border-[var(--kaypal-v3-border)] bg-[var(--kaypal-v3-paper-soft)] p-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          className="inline-flex h-11 shrink-0 items-center gap-2 rounded-[8px] bg-[image:var(--kaypal-v3-gradient-primary)] px-3 text-sm font-semibold text-white transition disabled:cursor-not-allowed disabled:opacity-60"
    ...
    <section className="kaypal-v3-panel overflow-hidden">
      ...
      <div className="grid xl:grid-cols-[minmax(0,1fr)_minmax(320px,0.72fr)]">
        ...
        <div className="p-4">
          ...
          <div className="mt-3 flex justify-end">
            <button
              className="inline-flex h-10 items-center gap-2 rounded-[8px] border border-[var(--kaypal-v3-border)] bg-[var(--kaypal-v3-paper)] px-3 text-sm font-semibold text-[var(--kaypal-v3-soft-ink)] transition hover:border-[var(--kaypal-v3-border-strong)] disabled:cursor-not-allowed disabled:opacity-60"
