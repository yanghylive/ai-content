...
export function GeoBridgeBanner() {
    ...
    const [status, setStatus] = React.useState<GeoBridgeStatus>("sent_to_ai_content");
    ...
    const handleCallback = async (nextStatus: GeoBridgeStatus) => {
        ...
        try {
            ...
            const resultUrl = typeof window !== "undefined" ? window.location.href : undefined;
            await postGeoBridgeCallback(context, {
                status: nextStatus,
                resultUrl,
                publishedUrl: nextStatus === "published" || nextStatus === "completed" ? resultUrl : undefined,
                attributionNote:
                    nextStatus === "running"
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div className="min-w-0">
                    <div className="mb-1 flex flex-wrap items-center gap-2">
                        <Chip color="success" size="sm" variant="flat">GEO 联动任务</Chip>
