...
export function ContentOptimizationWorkbench() {
  ...
  const resultActions = (
    <>
      ...
      <button
        className="inline-flex h-11 items-center gap-2 rounded-[8px] bg-[image:var(--kaypal-v3-gradient-primary)] px-3 text-sm font-semibold text-white transition hover:opacity-90"
        ...
        <div className="grid xl:grid-cols-[minmax(0,1.4fr)_minmax(320px,0.6fr)]">
          ...
          <aside className="p-4">
            ...
            <div className="mt-3 flex flex-col gap-2">
              ...
              <Link
                className="inline-flex h-11 items-center justify-between gap-2 rounded-[8px] bg-[image:var(--kaypal-v3-gradient-primary)] px-3 text-13 font-semibold text-white"
                href="/strategies"
              >
                内容策略
                <ArrowRight
