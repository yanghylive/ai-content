        ...
        <div className="mx-card" style={{ padding: 14 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              <input value={form.name} onChange={(e) => setField("name")(e.target.value)} placeholder="配置名称" style={{ minHeight: 40, width: "100%", minWidth: 0, padding: "0 10px", borderRadius: 10, border: "1px solid rgba(142,165,190,.3)", background: "rgba(255,255,255,.06)", color: "var(--kaypal-v3-ink)", fontSize: 13 }} />
              <input value={form.agentId} onChange={(e) => setField("agentId")(e.target.value)} placeholder="AgentId" style={{ minHeight: 40, width: "100%", minWidth: 0, padding: "0 10px", borderRadius: 10, border: "1px solid rgba(142,165,190,.3)", background: "rgba(255,255,255,.06)", color: "var(--kaypal-v3-ink)", fontSize: 13 }} />
            </div>
