                  ...
                  <span
                    className={`flex-none rounded-md px-2 py-0.5 text-11 font-medium ${
                      tone.chip === "success"
                        ...
                        : tone.chip === "warning"
                          ? "border-[var(--kaypal-v3-border)] bg-[var(--kaypal-v3-warning-soft)] text-[var(--kaypal-v3-warning-ink)]"
                          : tone.chip === "danger"
                            ? "border-[var(--kaypal-v3-danger-border)] bg-[var(--kaypal-v3-danger-soft)] text-[var(--kaypal-v3-danger-ink)]"
                            : tone.chip === "accent"
                              ? "border-[var(--kaypal-v3-border)] bg-[var(--kaypal-v3-paper-soft)] text-[var(--kaypal-v3-primary)]"
