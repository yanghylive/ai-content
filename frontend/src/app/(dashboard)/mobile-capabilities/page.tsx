  ...
  return (
    <div>
      ...
      <section className="mx-px" style={{ marginTop: 14 }}>
        <div className="mx-card" style={{ padding: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
            <span style={{ fontSize: 15, fontWeight: 700, color: "var(--kaypal-v3-success)" }}>✅ 手机上可直接完成</span>
          </div>
          {[
            ...
            <div key={title} style={{ display: "flex", gap: 10, padding: "8px 0", borderBottom: "1px solid rgba(255,255,255,.06)" }}>
              <span style={{ color: "var(--kaypal-v3-success)", flexShrink: 0 }}>✓</span>
              <div>
      ...
      <section className="mx-px" style={{ marginTop: 14 }}>
        <div className="mx-card" style={{ padding: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
            <span style={{ fontSize: 15, fontWeight: 700, color: "var(--kaypal-v3-amber)" }}>🖥️ 需要在电脑端完成</span>
          </div>
          {[
            ...
            <div key={title} style={{ display: "flex", gap: 10, padding: "8px 0", borderBottom: "1px solid rgba(255,255,255,.06)" }}>
              <span style={{ color: "var(--kaypal-v3-amber)", flexShrink: 0 }}>•</span>
              <div>
                <div style={{ fontSize: 13, fontWeight: 600 }}>{title}</div>
                <div style={{ fontSize: 11.5, color: "rgba(219,234,254,.58)", marginTop: 2 }}>{desc}</div>
              </div>
      ...
      {config?.features ? (
        <section className="mx-px" style={{ marginTop: 14 }}>
          <div className="mx-card" style={{ padding: 16 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
              <span style={{ fontSize: 15, fontWeight: 700, color: "var(--kaypal-v3-muted)" }}>⚙️ 工具能力状态</span>
            ...
            {Object.entries(FEATURE_LABELS).map(([key, label]) => (
              <div key={key} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid rgba(255,255,255,.06)" }}>
                ...
                <span style={{ fontSize: 11.5, fontWeight: 700, color: config.features[key] !== false ? "var(--kaypal-v3-success)" : "var(--kaypal-v3-danger)" }}>
