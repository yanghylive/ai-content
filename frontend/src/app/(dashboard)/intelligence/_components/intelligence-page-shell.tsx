      ...
      <section className="kaypal-v3-panel overflow-hidden">
        <header className="p-4">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              <span className="inline-flex h-7 items-center gap-1.5 rounded-[8px] border border-[var(--kaypal-v3-border)] bg-[var(--kaypal-v3-paper-soft)] px-2.5 text-[12px] font-semibold text-[var(--kaypal-v3-soft-ink)]">
                <Filter aria-hidden="true" className="h-3.5 w-3.5" />
                筛选
              </span>
              {page.filters.map((filter) => (
                <button
                  className="h-7 rounded-[8px] border border-[var(--kaypal-v3-border)] bg-[var(--kaypal-v3-paper)] px-3 text-[12px] font-semibold text-[var(--kaypal-v3-muted)] transition hover:border-[var(--kaypal-v3-border-strong)] hover:text-[var(--kaypal-v3-soft-ink)]"
                  key={filter}
                  type="button"
                >
                  {filter}
            ...
            {page.sources.map((source) => (
              <div className="p-4" key={source.name}>
                <div className="flex items-start justify-between gap-3">
                  ...
                  <span className="inline-flex shrink-0 items-center gap-1 rounded-[6px] border border-[var(--kaypal-v3-border)] bg-[var(--kaypal-v3-paper-soft)] px-2 py-1 text-[11px] font-semibold text-[var(--kaypal-v3-muted)]">
