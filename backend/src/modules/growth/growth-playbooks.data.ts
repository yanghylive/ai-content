...
export const WORKFLOW_INDUSTRIES: IndustryMeta[] = [
  {
    industry: '美业',
    audience: '25-45 岁注重形象与自我投资的女性，本地消费为主，决策受小红书种草与朋友圈口碑影响',
    goal: '新客到店体验 → 会员办卡 → 周期复购，建立「专业+懂我」的门店信任',
    pains: '怕被强推销、怕效果夸大失望、怕卫生与安全不达标、价格不透明',
    angles: '真实效果对比、客户变美故事、专业知识科普、项目避坑指南、限时福利、门店环境展示',
    style: '亲切专业、像闺蜜推荐而非销售话术、少套路多真诚、避免夸大承诺（医美需合规）',
    platforms: ['小红书', '抖音', '微信'],
    risk: ['医疗广告合规：禁止承诺疗效/绝对化用语', '平台违禁词：瘦脸针、水光针等功效描述需合规'],
    scenarioBName: '抖音本地到店引流',
    scenarioBDesc: '抖音同城内容引流 → 私信/留资 → 到店体验 → 办卡复购',
  },
  {
    industry: '餐饮',
    audience: '本地 18-50 岁吃货与家庭/朋友聚餐人群，追求性价比与新鲜感，决策受抖音探店/点评影响',
    goal: '到店引流 → 团购/储值 → 复购，建立「本地人爱吃」的烟火气口碑',
    pains: '怕难吃踩雷、怕贵不值、怕排队太久、怕卫生不达标',
    angles: '招牌菜实拍种草、隐藏菜单揭秘、老板创业故事、性价比实测、团购福利、聚餐场景',
    style: '烟火气、真实接地气、直给福利、用味道和氛围说话',
    platforms: ['抖音', '微信'],
    risk: ['团购套餐需真实可用，避免超卖/隐形消费差评', '卫生展示类内容避免踩监管红线'],
    scenarioBName: '本地团购到店转化',
    scenarioBDesc: '抖音团购套餐 → 核销承接 → 好评引导 → 复购触达',
  },
  {
    industry: '教育',
    audience: 'K12 家长（焦虑决策）与成人学习者（考证/技能提升），重视效果与口碑',
    goal: '课程咨询 → 试听转化 → 报课 → 续费/转介绍，建立「专业可信」的教育品牌',
    pains: '怕无效浪费钱、怕踩坑选错机构、怕孩子落后焦虑、怕老师不专业',
    angles: '学习方法干货、误区澄清、学员成果见证、师资展示、限时优惠、教育理念共鸣',
    style: '专业可信、有权威感、共情但不贩卖焦虑、用数据与成果说话',
    platforms: ['抖音', '视频号', '微信'],
    risk: ['政策合规：K12 学科类宣传需符合双减要求', '禁止承诺提分/保过等绝对化效果'],
  ...
  },
  {
    ...
    platforms: ['微信'],
    risk: ['避免夸大功效/收益承诺，防止被判定虚假宣传', '不刷屏：控制发圈频次与硬广占比'],
  ...
  },
  {
    ...
    angles: '事业机会理性展示、制度透明解读、领导人成长故事、新人 30 天见证、招商会邀约',
    style: '理性+正能量、不吹嘘不画饼、透明讲清模式与投入、严禁收益承诺与拉人头（传销红线）',
    platforms: ['微信', '抖音'],
    risk: ['传销红线：严禁拉人头返利、收益承诺话术', '宣传须透明讲清制度与投入，不夸大收入'],
  ...
  },
  {
    ...
    angles: '学员前后对比见证、教练专业展示、训练误区科普、体验课福利、训练日常氛围',
    style: '专业有能量、激励但不贩卖焦虑、强调科学训练与陪伴感',
    platforms: ['抖音', '小红书'],
    risk: ['效果对比图需真实，避免 P 图夸大', '私教宣传避免绝对化承诺（如"30 天瘦 20 斤"）'],
  ...
  },
  {
    ...
    angles: '育儿知识干货、产品安全科普（成分/认证）、产后恢复科学讲解、真实妈妈案例',
    style: '温暖专业、像懂行的闺蜜妈妈、用知识建立信任、不制造焦虑',
    platforms: ['小红书', '微信'],
    risk: ['母婴用品宣传需真实，避免误导性功效描述', '育儿内容避免贩卖焦虑引发投诉'],
  ...
  },
  {
    ...
    angles: '服务过程真实展示（前后对比）、价格透明承诺、专业资质展示、客户好评见证',
  ...
  {
    industry: '电商零售',
    audience: '18-45 岁网购人群，决策受种草内容/优惠/评价影响，复购靠品质与体验',
    goal: '新品种草 → 下单转化 → 复购 → 会员沉淀',
    pains: '怕货不对板、怕质量差色差、价格对比焦虑、选择困难',
    angles: '新品实拍种草、使用场景展示、材质工艺细节、真实买家秀、限时优惠、搭配攻略',
    style: '活泼种草、真实不吹、用场景与细节说话、突出性价比与售后保障',
    platforms: ['抖音', '小红书', '微信'],
    risk: ['商品宣传需与实际一致（材质/功效），避免夸大', '优惠活动规则清晰，避免价格欺诈投诉'],
  ...
  },
  {
    ...
    angles: '健康科普干货、常见误区澄清、医生专业背景展示、体检流程透明、真实患者（脱敏）见证',
    style: '专业严谨可信、通俗易懂、用资质与数据说话、严禁疗效承诺与夸大（广告法红线）',
    platforms: ['抖音', '微信公众号'],
    risk: ['广告法红线：严禁疗效承诺/绝对化用语', '患者案例需脱敏授权，禁止展示可识别信息'],
    scenarioBName: '体检到院转化',
    scenarioBDesc: '健康科普内容 → 私信/表单留资 → 到院体检 → 家庭复购',
  },
  {
    industry: '家装',
    audience: '25-50 岁有装修/翻新需求的城市家庭，低频高客单决策，信任与口碑决定签约',
    goal: '案例展示 → 咨询量房 → 签约 → 转介绍',
    pains: '怕跑路增项、怕材料以次充好、怕工期拖延、不懂验收被糊弄',
    angles: '真实装修案例前后对比、避坑指南（增项/材料/验收）、报价透明拆解、工地实拍进度',
  ...
  {
    industry: '汽车后市场',
    audience: '20-50 岁车主（家庭主力决策），本地刚需高频服务，决策靠口碑/价格/便利',
    goal: '到店引流 → 保养/美容套餐 → 复购储值',
    pains: '怕被宰过度维修、怕用假配件、怕技术不行伤车、排队久',
    angles: '保养知识科普、真假配件鉴别、维修过程透明展示、价格清单公开、会员储值福利',
  ...
  },
  {
    ...
    angles: '真实房源实拍介绍、购房流程科普（贷款/税费/过户）、避坑指南、区域价值分析、笋盘速递',
  ...
  {
    industry: '婚庆摄影',
    audience: '20-35 岁准新人（新娘决策主导），高客单低频，作品质量与口碑决定选择',
    goal: '作品展示 → 咨询到店 → 下单拍摄 → 转介绍',
    pains: '怕拍出来丑修图假、怕隐性消费加钱、怕成品延期丢片、风格同质化',
    angles: '客片实拍展示（不同风格）、拍摄过程花絮、成片前后对比、套餐透明拆解、档期福利',
...
/** 查询行业场景 Playbook */
export function industryPlaybook(industry: string, scenarioKey?: string): IndustryScenario | undefined {
  const meta = WORKFLOW_INDUSTRIES.find((m) => m.industry === industry);
  if (!meta) return undefined;
  const isB = scenarioKey === 'local-conversion' || scenarioKey === 'platform-b';
  const scenarioB = {
...
export function listWorkflowPlaybooks(): Array<{
  industry: string;
  scenarios: Array<{ key: string; name: string; description: string; platforms: string[]; stepCount: number; riskNotes: string[] }>;
}> {
  return WORKFLOW_INDUSTRIES.map((meta) => {
    ...
    return {
      ...
      scenarios: [
        { key: a.key, name: a.name, description: a.description, platforms: a.platforms, stepCount: a.steps.length, riskNotes: a.riskNotes },
        { key: b.key, name: b.name, description: b.description, platforms: b.platforms, stepCount: b.steps.length, riskNotes: b.riskNotes },
      ],
    };
  });
}
