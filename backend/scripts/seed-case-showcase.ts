...
const CASES: CaseSeed[] = [
  ...
  {
    slug: 'cordys-crm',
    title: 'Cordys CRM 客户管理',
    subtitle: '面向小微企业的客户、商机与销售跟进管理',
    provenanceType: 'open_source',
    primaryPlatform: 'web',
    platforms: ['web'],
    primaryIndustry: 'saas',
    ...
    businessProblem:
      '小微企业缺乏统一的客户与销售跟进工具，客户信息分散、商机跟进易遗漏。',
    solutionSummary:
      '基于开源 Cordys CRM 搭建客户与销售管理，支持客户、联系人、商机与跟进流程统一管理。',
    keyFeatures: [
      { title: '客户管理', description: '客户、联系人信息统一维护' },
      { title: '商机跟进', description: '商机阶段与销售跟进流程管理' },
      { title: '销售报表', description: '销售漏斗与业绩统计' },
    ],
    resultsSummary: '九章已完成部署与适配，可开通企业实例体验。',
    evidenceLevel: 'E1',
    evidenceScope: '开源项目文档与演示环境',
    deliveryModes: ['web', 'download'],
    maturity: 'mvp',
    techSummary: '开源 CRM + 销售流程',
    seoTitle: 'Cordys CRM 客户管理 - 九章智能',
    seoDescription: '九章部署的开源客户与销售管理应用演示。',
    publishedDaysAgo: 12,
  },
  {
    slug: 'nocobase',
    title: 'NocoBase 企业业务工作台',
    subtitle: '可视化的企业业务系统搭建平台',
    provenanceType: 'open_source',
    primaryPlatform: 'web',
    platforms: ['web'],
    primaryIndustry: 'saas',
    ...
    capabilityTags: ['automation', 'data_analysis'],
    businessProblem:
      '企业业务系统开发周期长、需求变化快，缺乏灵活的可视化搭建工具。',
    solutionSummary:
      '基于开源 NocoBase 搭建企业业务工作台，支持可视化建模、插件扩展与私有部署。',
    keyFeatures: [
      { title: '可视化建模', description: '无需编码搭建业务数据模型' },
      { title: '插件扩展', description: '丰富的插件生态与二次开发' },
      { title: '私有部署', description: '数据自持，安全可控' },
    ],
    resultsSummary: '九章已完成部署与适配，可开通企业实例体验。',
    evidenceLevel: 'E1',
    evidenceScope: '开源项目文档与演示环境',
    ...
    maturity: 'mvp',
    techSummary: '开源低代码平台',
    seoTitle: 'NocoBase 企业业务工作台 - 九章智能',
    seoDescription: '九章部署的开源企业业务系统搭建平台演示。',
    publishedDaysAgo: 11,
  },
  {
    slug: 'umami',
    title: 'Umami 网站经营分析',
    subtitle: '轻量、隐私友好的网站访问分析',
    provenanceType: 'open_source',
    primaryPlatform: 'web',
    platforms: ['web'],
    primaryIndustry: 'saas',
    industries: ['saas'],
    capabilityTags: ['data_analysis'],
    businessProblem:
      '企业需要了解网站访问与转化情况，但商业分析工具成本高、数据合规顾虑大。',
    solutionSummary:
      '基于开源 Umami 搭建网站分析，支持访问量、来源、转化等指标，隐私友好可私有部署。',
    keyFeatures: [
      { title: '访问分析', description: '访问量、来源、页面等核心指标' },
      { title: '隐私友好', description: '不采集个人隐私，符合合规要求' },
      { title: '私有部署', description: '数据自持，可独立部署' },
    ],
    resultsSummary: '九章已完成部署与适配，可开通企业实例体验。',
    evidenceLevel: 'E1',
    evidenceScope: '开源项目文档与演示环境',
    ...
    maturity: 'mvp',
    techSummary: '开源网站分析',
    seoTitle: 'Umami 网站经营分析 - 九章智能',
    seoDescription: '九章部署的开源网站访问分析应用演示。',
    publishedDaysAgo: 10,
  },
  {
    slug: 'uptime-kuma',
    title: 'Uptime Kuma 服务运行监控',
    subtitle: '开源的服务可用性与运行状态监控',
    provenanceType: 'open_source',
    primaryPlatform: 'web',
    platforms: ['web'],
    primaryIndustry: 'saas',
    ...
    capabilityTags: ['automation', 'data_analysis'],
    businessProblem:
      '企业服务缺乏统一的可用性监控，故障发现滞后，影响业务连续性。',
    solutionSummary:
      '基于开源 Uptime Kuma 搭建服务监控，支持可用性探测、状态页与多渠道告警。',
    keyFeatures: [
      { title: '可用性探测', description: 'HTTP/TCP/证书等多类型监控' },
      { title: '多渠道告警', description: '邮件、钉钉、飞书等告警通知' },
      { title: '状态页', description: '对外展示服务健康状态' },
    ],
    resultsSummary: '九章已完成部署与适配，可开通企业实例体验。',
    evidenceLevel: 'E1',
    evidenceScope: '开源项目文档与演示环境',
    ...
    maturity: 'mvp',
    techSummary: '开源监控平台',
    seoTitle: 'Uptime Kuma 服务运行监控 - 九章智能',
    seoDescription: '九章部署的开源服务可用性监控应用演示。',
    publishedDaysAgo: 9,
  },
  {
    slug: 'openpencil',
    title: 'OpenPencil AI 设计工具',
    subtitle: 'AI 矢量设计与 UI 生成',
    provenanceType: 'open_source',
    primaryPlatform: 'web',
    platforms: ['web'],
    primaryIndustry: 'saas',
    ...
    capabilityTags: ['ai_content_generation'],
    businessProblem:
      '设计团队需要快速产出矢量设计与 UI 稿，传统工具学习成本高、协作效率低。',
    solutionSummary:
      '基于开源 OpenPencil 搭建 AI 设计工具，支持 AI 矢量设计与 UI 生成。',
    keyFeatures: [
      { title: 'AI 生成', description: 'AI 辅助矢量设计与 UI 生成' },
      { title: '矢量编辑', description: '专业的矢量编辑能力' },
      { title: '协作', description: '设计稿分享与协作' },
    ],
    resultsSummary: '九章已完成部署与适配，可开通企业实例体验。',
    evidenceLevel: 'E1',
    evidenceScope: '开源项目文档与演示环境',
    deliveryModes: ['web', 'download'],
    maturity: 'mvp',
    techSummary: '开源设计工具 + AI',
    seoTitle: 'OpenPencil AI 设计工具 - 九章智能',
    seoDescription: '九章部署的开源 AI 设计工具演示。',
    publishedDaysAgo: 8,
  },
  {
    slug: 'ai-content',
...
const DEMO_ENDPOINTS: DemoEndpointSeed[] = [
  // 开源应用（九章真实部署，独立子域在线体验）
  {
    slug: 'open-source-customer-support-bot',
    endpointType: 'web',
    targetUrl: 'https://maxkb.opensource.kaypal.cn/',
    shortCode: 'jzmaxkb',
    allowedDevices: ['desktop', 'mobile'],
    accessInstruction: '九章部署的 MaxKB 企业知识库，新窗口打开',
  },
  {
    slug: 'open-source-content-workbench',
    endpointType: 'web',
    targetUrl: 'https://halo.opensource.kaypal.cn/',
    shortCode: 'jzhalo',
    allowedDevices: ['desktop'],
    accessInstruction: '九章部署的 Halo 内容门户，新窗口打开',
  },
  {
    slug: 'cordys-crm',
    endpointType: 'web',
    targetUrl: 'https://cordys.opensource.kaypal.cn/',
    shortCode: 'jzcordys',
    allowedDevices: ['desktop', 'mobile'],
    accessInstruction: '九章部署的 Cordys CRM，新窗口打开',
  },
  {
    slug: 'nocobase',
    endpointType: 'web',
    targetUrl: 'https://nocobase.opensource.kaypal.cn/',
    shortCode: 'jznocobase',
    allowedDevices: ['desktop'],
    accessInstruction: '九章部署的 NocoBase 业务工作台，新窗口打开',
  },
  {
    slug: 'umami',
    endpointType: 'web',
    targetUrl: 'https://umami.opensource.kaypal.cn/',
    shortCode: 'jzumami',
    allowedDevices: ['desktop', 'mobile'],
    accessInstruction: '九章部署的 Umami 网站分析，新窗口打开',
  },
  {
    slug: 'uptime-kuma',
    endpointType: 'web',
    targetUrl: 'https://uptime-kuma.opensource.kaypal.cn/',
    shortCode: 'jzuptime',
    allowedDevices: ['desktop'],
    accessInstruction: '九章部署的 Uptime Kuma 监控，新窗口打开',
  },
  {
    slug: 'openpencil',
    endpointType: 'web',
    targetUrl: 'https://openpencil.opensource.kaypal.cn/',
    shortCode: 'jzpencil',
    allowedDevices: ['desktop'],
    accessInstruction: '九章部署的 OpenPencil 设计工具，新窗口打开',
  },
  // 九章自有产品（在线体验）
  {
    slug: 'ai-content',
...
const AUTHORIZATIONS: AuthorizationSeed[] = [
  ...
  // 新增开源应用（九章真实部署）
  {
    ...
    scope: '本案例为开源能力演示，非九章客户交付项目',
    licenseName: 'GPL/AGPL',
    sourceUrl: 'https://github.com/1Panel-dev/CordysCRM',
    versionOrCommit: 'main',
    restrictionNotes: '开源演示，复用前需核验许可证与依赖',
  },
  {
    ...
    sourceUrl: 'https://github.com/nocobase/nocobase',
    versionOrCommit: 'main',
    restrictionNotes: '开源演示，复用前需核验许可证与依赖',
  },
  {
  ...
  },
  {
    ...
    scope: '本案例为开源能力演示，非九章客户交付项目',
    licenseName: '开源许可证',
    sourceUrl: 'https://github.com/ZSeven-W/openpencil',
    versionOrCommit: 'main',
    restrictionNotes: '开源演示，复用前需核验许可证与依赖',
  },
  // 九章自有产品
