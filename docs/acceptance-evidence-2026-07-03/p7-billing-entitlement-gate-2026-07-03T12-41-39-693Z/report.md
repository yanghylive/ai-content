...
- Generated: 2026-07-03T12:41:39.713Z
...
| CONFIG_REQUIRED | 订阅与权益一致性 | 有效订阅=0，有效权益=1，缺权益=0，孤立权益=1。 | backend/prisma/data/sqlite-runtime/kaypal-ai.sqlite | 重放订阅 webhook 或修复权益同步，确保权益来自计费订阅而不是本地开关。 |
| PASS | 备份中的计费数据辅助证据 | 最近 Postgres 备份包含计费表结构和计费数据。 | docs/acceptance-evidence-2026-07-03/commercial-external-ops-smoke-2026-07-03T05-36-58-493Z/downloaded-backup/postgres-dump.sql | 保留该证据作为恢复链路的计费数据佐证。 |
