...
- Generated: 2026-07-03T11:39:03.231Z
...
| BLOCKER | 可上线基础 | 全站用户侧商用文案与工程词泄露 | 未找到通过的全站商用文案浏览器扫描。 | docs/acceptance-evidence-2026-07-03/commercial-copy-browser-scan-2026-07-03T11-27-56-854Z.json | 运行 COMMERCIAL_COPY_LOCAL_ACCEPTANCE_LOGIN=1 node frontend/scripts/commercial-copy-browser-scan.mjs。 |
...
| PASS | 可上线基础 | 支付/订阅回调与权益一致性 | 发现支付/订阅或权益相关证据文件。 | docs/acceptance-evidence-2026-07-03/p4-business-journey-2026-07-03T11-16-56-247Z/crm-phase1/report.json | 生产发布前用真实支付测试模式重跑回调、幂等、退款/失效和权益同步。 |
