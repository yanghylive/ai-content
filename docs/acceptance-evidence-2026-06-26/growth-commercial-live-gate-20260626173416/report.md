...
Status: **BLOCKED**
Generated: 2026-06-26T17:34:16.786Z

## Checks

- **PASS** backend-process: Backend listening on 3011, pid=93288.
- **PASS** auth-cookie: Auth cookie/session token was provided to the gate.
- **PASS** auth-me: Authenticated as Codex Smoke.
- **BLOCKER** commercial-permission: commercialExecutionAllowed=false, planMode=paid, kaypalPlan=FREE, expired=false.
...
- **PASS** schedule-plan-api: items=1, ready=0, blocked=0, waiting=0.
