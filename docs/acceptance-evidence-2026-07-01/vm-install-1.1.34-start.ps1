...
$out = "C:\Users\Public\kaypal-install-1.1.34"
New-Item -ItemType Directory -Force -Path $out | Out-Null
"starter $(Get-Date -Format o)" | Out-File -Encoding utf8 "$out\starter.log"
$task = "KaypalInstall1134"
schtasks /delete /tn $task /f | Out-File -Append -Encoding utf8 "$out\starter.log"
schtasks /create /tn $task /tr "C:\Windows\Temp\kaypal-install-1.1.34-run.cmd" /sc once /st 23:59 /f /it /ru "WIN-LF040VM3F47\signer" | Out-File -Append -Encoding utf8 "$out\starter.log"
