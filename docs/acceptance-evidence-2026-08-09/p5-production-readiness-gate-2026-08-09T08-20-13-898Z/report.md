...
| BLOCKER | 可上线基础 | 全站用户侧商用文案与工程词泄露 | 未找到通过的全站商用文案浏览器扫描。 | docs/acceptance-evidence-2026-08-09/commercial-copy-browser-scan-2026-08-09T08-13-47-493Z.json | 运行 COMMERCIAL_COPY_LOCAL_ACCEPTANCE_LOGIN=1 node frontend/scripts/commercial-copy-browser-scan.mjs。 |
