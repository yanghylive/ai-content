...
- Generated: 2026-08-09T11:40:22.026Z
...
| --- | --- | --- | --- | --- | --- |
| PASS | 可上线基础 | 创作优化到发布准备业务闭环 | P4 业务旅程通过；PASS=20，FAIL=0，BLOCKED=0。 | docs/acceptance-evidence-2026-08-09/p4-business-journey-2026-08-09T11-25-27-924Z/report.json | 保持 p4-business-journey-smoke 作为回归门禁。 |
| PASS | 可上线基础 | CRM 本地导入写入和回滚 | CRM Phase 1 写入、回滚、时间线、批次台账、审计记录均通过。 | docs/acceptance-evidence-2026-08-09/p4-business-journey-2026-08-09T11-25-27-924Z/crm-phase1 | 继续限定为本地 CRM 写入；外部 CRM 同步另走真账号门禁。 |
...
| PASS | 可上线基础 | 全站页面控制台与请求质量 | 控制台质量通过：routes=199，errors=0，warnings=0，requestFailures=0。 | docs/acceptance-evidence-2026-08-09/console-quality-browser-scan-2026-08-09T11-28-52-625Z.json | 保持 console-quality-browser-scan 作为 UI 质量回归。 |
...
| CONFIG_REQUIRED | 需生产配置 | 备份、恢复、对象存储与值班告警 | P6 生产配置门禁阻断 1 项：值班告警真实通道: 未配置 COMMERCIAL_BACKUP_ALERT_WEBHOOK_URL。 | docs/acceptance-evidence-2026-08-09/p6-production-config-gate-2026-08-09T11-39-47-578Z/report.json | 填入企业微信/飞书/Slack 值班群 webhook 后再跑。 |
...
| CONFIG_REQUIRED | 需生产配置 | 第三方 CRM 生产同步 | 本地 CRM 写入回滚已通过；第三方 CRM 当前只证明连接方案和只读边界，不证明生产写入同步。 | docs/acceptance-evidence-2026-08-09/p4-business-journey-2026-08-09T11-25-27-924Z/crm-phase1 | 配置专属安全保护、真实 HubSpot/Salesforce 测试租户、字段白名单、可撤销授权和回滚方案后，再做外部 CRM 写入验收。 |
