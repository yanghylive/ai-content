...
- 证据目录：/Users/yanghy/Documents/New project/ai-content/docs/acceptance-evidence-2026-07-08/wechat-contacts-real-macos-account-guard
- API：http://127.0.0.1:3011/api
- 模拟器：未启用
- 真实同步：已启用

- 生成时间：2026-07-08T21:50:30.609Z
...
```bash
node scripts/wechat-windows-contacts-acceptance.mjs --real --base-url http://127.0.0.1:3011/api --evidence-dir "/Users/yanghy/Documents/New project/ai-content/docs/acceptance-evidence-2026-07-08/wechat-contacts-real-macos-account-guard"
```
