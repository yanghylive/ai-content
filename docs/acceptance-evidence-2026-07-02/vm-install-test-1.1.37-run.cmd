...
taskkill /F /IM "ai-content-desktop.exe" >> "%OUT%\test.log" 2>&1
taskkill /F /IM "node.exe" >> "%OUT%\test.log" 2>&1
echo install-start %DATE% %TIME% >> "%OUT%\test.log"
