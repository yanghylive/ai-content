...
- Generated: 2026-06-30T17:11:47.247Z
- Platform: win32
- Simulator: yes
...
- BLOCKED native-command-real:group-broadcast (required) -> 05-native-command-group-broadcast.json: 请先启动并登录 Windows 桌面微信，保持主窗口可见后重试。
- BLOCKED native-command-real:contact-add (required) -> 05-native-command-contact-add.json: 请先启动并登录 Windows 桌面微信，保持主窗口可见后重试。
- BLOCKED native-command-real:moments-publish (required) -> 05-native-command-moments-publish.json: 请先启动并登录 Windows 桌面微信，保持主窗口可见后重试。
- BLOCKED native-command-real:moments-marketing (required) -> 05-native-command-moments-marketing.json: 请先启动并登录 Windows 桌面微信，保持主窗口可见后重试。
- BLOCKED native-command-real:chat-history (required) -> 05-native-command-chat-history.json: 请先启动并登录 Windows 桌面微信，保持主窗口可见后重试。
