...
- 证据目录：/Users/yanghy/Documents/New project/ai-content/docs/acceptance-evidence-2026-06-28/windows-wechat-contacts-simulator
- API：http://127.0.0.1:3011
- 模拟器：已启用
- 真实同步：未启用
- 说明：这是本机模拟器证据，只验证 random/all 合同、诊断和导出链路，不等同 Windows 真机通过。
- 生成时间：2026-06-28T16:44:55.760Z
...
```bash
node scripts/wechat-windows-contacts-acceptance.mjs --simulator --base-url http://127.0.0.1:3011 --evidence-dir "/Users/yanghy/Documents/New project/ai-content/docs/acceptance-evidence-2026-06-28/windows-wechat-contacts-simulator"
```
